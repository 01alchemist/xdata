...
for(var e=new Uint8Array(new ArrayBuffer(c)),b=0;b<c;b++)e[b]=this.data.getUint8(this.position),this.position+=a.SIZE_OF_UINT8;return e};a.prototype.readUint16Array=function(c){var e=c*a.SIZE_OF_UINT16;if(!this.validate(e))return null;for(var e=new Uint16Array(new ArrayBuffer(e)),b=0;b<c;b++)e[b]=this.data.getUint16(this.position),this.position+=a.SIZE_OF_UINT16;return e};a.prototype.readUint32Array=function(c){var e=c*a.SIZE_OF_UINT32;if(!this.validate(e))return null;for(var e=new Uint32Array(new ArrayBuffer(e)),
b=0;b<c;b++)e[b]=this.data.getUint32(this.position),this.position+=a.SIZE_OF_UINT32;return e};a.prototype.readInt8Array=function(c){if(!this.validate(c))return null;for(var b=new Int8Array(new ArrayBuffer(c)),d=0;d<c;d++)b[d]=this.data.getInt8(this.position),this.position+=a.SIZE_OF_INT8;return b};a.prototype.readInt16Array=function(c){var b=c*a.SIZE_OF_INT16;if(!this.validate(b))return null;for(var b=new Int16Array(new ArrayBuffer(b)),d=0;d<c;d++)b[d]=this.data.getInt16(this.position),this.position+=
a.SIZE_OF_INT16;return b};a.prototype.readInt32Array=function(c){var b=c*a.SIZE_OF_INT32;if(!this.validate(b))return null;for(var b=new Int32Array(new ArrayBuffer(b)),d=0;d<c;d++)b[d]=this.data.getUint32(this.position),this.position+=a.SIZE_OF_INT32;return b};a.prototype.readFloat32Array=function(c){var b=c*a.SIZE_OF_FLOAT32;if(!this.validate(b))return null;for(var b=new Float32Array(new ArrayBuffer(b)),d=0;d<c;d++)b[d]=this.data.getFloat32(this.position),this.position+=a.SIZE_OF_FLOAT32;return b};
a.prototype.readFloat64Array=function(c){var b=c*a.SIZE_OF_FLOAT64;if(!this.validate(b))return null;for(var b=new Float64Array(new ArrayBuffer(b)),d=0;d<c;d++)b[d]=this.data.getFloat64(this.position),this.position+=a.SIZE_OF_FLOAT64;return b};a.prototype.validate=function(a){a+=this.offset;if(0<this.data.byteLength&&this._position+a<=this.data.byteLength)return!0;throw{name:"Error",message:"Error #2030: End of file was encountered.",errorID:2030};};a.prototype.validateBuffer=function(a){this.write_position=
a>this.write_position?a:this.write_position;this.data.byteLength<a&&(a=new Uint8Array(new ArrayBuffer(a+this.BUFFER_EXT_SIZE)),a.set(new Uint8Array(this.data.buffer)),this.data.buffer=a.buffer)};a.prototype.encodeUTF8=function(a){var b=0;a=this.stringToCodePoints(a);for(var d=[];a.length>b;){var f=a[b++];if(this.inRange(f,55296,57343))this.encoderError(f);else if(this.inRange(f,0,127))d.push(f);else{var h,l;this.inRange(f,128,2047)?(h=1,l=192):this.inRange(f,2048,65535)?(h=2,l=224):this.inRange(f,
65536,1114111)&&(h=3,l=240);for(d.push(this.div(f,Math.pow(64,h))+l);0<h;){var k=this.div(f,Math.pow(64,h-1));d.push(128+k%64);h-=1}}}return new Uint8Array(d)};a.prototype.decodeUTF8=function(a){for(var b=0,d="",f,h=0,l=0,k=0,n=0;a.length>b;){f=a[b++];if(f===this.EOF_byte)f=0!==l?this.decoderError(!1):this.EOF_code_point;else if(0===l)this.inRange(f,0,127)||(this.inRange(f,194,223)?(l=1,n=128,h=f-192):this.inRange(f,224,239)?(l=2,n=2048,h=f-224):this.inRange(f,240,244)?(l=3,n=65536,h=f-240):this.decoderError(!1),
h*=Math.pow(64,l),f=null);else if(this.inRange(f,128,191))if(k+=1,h+=(f-128)*Math.pow(64,l-k),k!==l)f=null;else{var m=h,q=n,n=k=l=h=0;f=this.inRange(m,q,1114111)&&!this.inRange(m,55296,57343)?m:this.decoderError(!1,f)}else n=k=l=h=0,b--,f=this.decoderError(!1,f);null!==f&&f!==this.EOF_code_point&&(65535>=f?0<f&&(d+=String.fromCharCode(f)):(f-=65536,d+=String.fromCharCode(55296+(f>>10&1023)),d+=String.fromCharCode(56320+(f&1023))))}return d};a.prototype.encoderError=function(a){throw{name:"EncodingError",
message:"The code point "+a+" could not be encoded.",errorID:0};};a.prototype.decoderError=function(a,b){if(a)throw{name:"DecodingError",message:"DecodingError.",errorID:0};return b||65533};a.prototype.inRange=function(a,b,d){return b<=a&&a<=d};a.prototype.div=function(a,b){return Math.floor(a/b)};a.prototype.stringToCodePoints=function(a){for(var b=[],d=0,f=a.length;d<a.length;){var h=a.charCodeAt(d);if(this.inRange(h,55296,57343))if(this.inRange(h,56320,57343))b.push(65533);else if(d===f-1)b.push(65533);
else{var l=a.charCodeAt(d+1);this.inRange(l,56320,57343)?(h&=1023,l&=1023,d+=1,b.push(65536+(h<<10)+l)):b.push(65533)}else b.push(h);d+=1}return b};a.BIG_ENDIAN="bigEndian";a.LITTLE_ENDIAN="littleEndian";a.SIZE_OF_BOOLEAN=1;a.SIZE_OF_INT8=1;a.SIZE_OF_INT16=2;a.SIZE_OF_INT32=4;a.SIZE_OF_UINT8=1;a.SIZE_OF_UINT16=2;a.SIZE_OF_UINT32=4;a.SIZE_OF_FLOAT32=4;a.SIZE_OF_FLOAT64=8;return a}();b.ByteArray=d})(d.utils||(d.utils={}))})(nid||(nid={}));
