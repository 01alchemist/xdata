...
export declare class ByteArray {
     ...
     */
    readBytes(_bytes?: ByteArray, offset?: number, length?: number, createNewBuffer?: boolean): ByteArray;
    /**
     ...
     */
    writeBytes(_bytes: ByteArray, offset?: number, length?: number): void;
    /**
